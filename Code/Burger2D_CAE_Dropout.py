...
autoencoder.save(os.getcwd() + f'/dropout/AE_Burger2D_{nodes_enc[0]}nh_Simulation{index-1}_MCDropout{dropout_rate}.keras')
...
output = open(os.getcwd() + f'/dropout/AE_Burger2D_predictions_Simulation{index-1}_MCDropout{dropout_rate}.pkl', 'wb')
